...
namespace GeneralHelpers.Scheduling
{
    ...
    //            events = maxEvents;
    //            fileOps = new FileOperations(fileName,"Scheduler");
    ...
    //        {
    //            string jsonString = "";
    //            fileOps.ReadFromFile(out jsonString);
    ...
    //            fileOps.WriteToFile(JsonConvert.SerializeObject(list,settings),  true) ;
    //        }
    //        catch (Exception e)
    //        {
    ...
    //    /// </summary>
    //    /// <param name="up"></param>
    //    public void AdjustHour(bool up)
    //    {
    ...
    //    /// </summary>
    //    /// <param name="up"></param>
    //    public void AdjustMinute(bool up)
    //    {
    ...
    //    /// <summary>
    //    /// Adjust active state of specified event
    //    /// </summary>
    //    /// <param name="active"></param>
    //    public void SetScheduleState(bool active)
    //    {
